...
import ImprimerListesPedagogie from "./pages/pedagogie/ImprimerListesPedagogie";
...
import ImprimerListesBibliotheque from "./pages/bibliotheque/ImprimerListesBibliotheque";
...
import ImprimerListesInfirmerie from "./pages/infirmerie/ImprimerListesInfirmerie";
...
{/* Dashboard Routes */}
          ...
          <Route path="/pedagogie/listes" element={<MainLayout><ImprimerListesPedagogie /></MainLayout>} />
...
<Route path="/scolarite/alertes" element={<MainLayout><AlertesImpayes /></MainLayout>} />
          ...
          <Route path="/bibliotheque/listes" element={<MainLayout><ImprimerListesBibliotheque /></MainLayout>} />
          ...
          <Route path="/infirmerie/listes" element={<MainLayout><ImprimerListesInfirmerie /></MainLayout>} />
